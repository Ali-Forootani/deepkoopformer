...
def main(file="bitstamp_windows.npy", epochs=200, seq_len=120,
    ...
    patch_lens = patch_lens or [40, 50, 60, 70, 80, 90, 100]
    ...
    for patch_len in patch_lens:
        for horizon in horizons:
            ...
            model_variants = {
                ...
                "Koop-PatchTST": Koopformer_PatchTST(F, patch_len, H, patch_len, d_model=64),
                "Koop-Autoformer": Koopformer_Autoformer(F, patch_len, H, patch_len, d_model=64),
                "Koop-Informer": Koopformer_Informer(F, patch_len, H, patch_len, d_model=64),
            }
